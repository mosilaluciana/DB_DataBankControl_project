...
SELECT nume
FROM Persoane
WHERE idpers IN (SELECT idpers 
                 FROM Conturi cardpers1
                 WHERE (SELECT count(nume)
                 FROM Conturi cardpers2
                         WHERE cardpers1.idpers = cardpers2.idpers
                         GROUP BY idpers  ) = 1)";
